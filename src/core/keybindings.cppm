...
export enum class EditorAction {
    MoveLeft,
    VisualMoveLeft,
    MoveRight,
    VisualMoveRight,
...
export struct KeyBindings {
    std::vector<KeyBinding> bindings;
    std::string source_path;
};

export struct KeyDispatch {
    bool matched = false;
...
export struct KeyHint {
    std::string token;
    std::string detail;
};

export KeyBindings load_keybindings();
export KeyBindings load_keybindings(const EditorConfig &config);
export KeyBindings load_keybindings_from_path(const std::filesystem::path &path);
export KeyBindings load_embedded_keybindings();
export void remove_action_bindings(KeyBindings &keybindings, EditorAction action);
export std::vector<KeyHint> key_hints_for_prefix(
    const KeyBindings &keybindings,
    const std::string &mode,
    const std::vector<std::string> &prefix);
export KeyDispatch dispatch_key_sequence(
    const KeyBindings &keybindings,
    const std::string &mode,
    std::vector<std::string> &pending_tokens,
    const std::string &token,
    bool printable);
export std::string action_name(EditorAction action);
...
constexpr const char *kEmbeddedDefaultKeybindings = R"json(
{
  "normal": {
    ...
    "up": "move_screen_up",
    "shift-up": "visual_move_screen_up",
    "down": "move_screen_down",
    "shift-down": "visual_move_screen_down",
...
const std::map<std::string, EditorAction> &action_map() {
    static const std::map<std::string, EditorAction> kActions = {
        ...
        {"move_screen_up", EditorAction::MoveScreenUp},
        {"visual_move_screen_up", EditorAction::VisualMoveScreenUp},
        {"move_screen_down", EditorAction::MoveScreenDown},
        {"visual_move_screen_down", EditorAction::VisualMoveScreenDown},
        ...
        {"jump_to_matching_pair", EditorAction::JumpToMatchingPair},
        {"visual_jump_to_matching_pair", EditorAction::VisualJumpToMatchingPair},
